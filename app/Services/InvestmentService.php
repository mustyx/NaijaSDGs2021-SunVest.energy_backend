...
class InvestmentService
{
    public function createNewInvestment($request){
        ...
        $startDate = $project->end_date->addDay();
        $dueDate = $project->end_date->addDay()->addWeeks($project->maturity_period);
    ...
    public function userCreateNewInvestment($request){
        $project = Project::where('id',$request->project_id)->orWhere('slug',$request->project_id)->firstOrFail();
    ...
    public function processPayment($investment){
        $paymentService = new PaymentService();
        return $paymentService->createPayment($investment);
    }
}
